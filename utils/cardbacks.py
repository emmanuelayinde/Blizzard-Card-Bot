...
website = 'https://hearthstone.blizzard.com/en-gb/cardbacks'
...
def scrape(webdriver, Service, chrome_options, WebDriverWait, By, EC):
    ...
    for card in all_cards_link:
        ...
        if tweeted:
            ...
            with open(path +"/data/cardbacks.txt", 'a') as f:
...
def scrape_card_info(driver, By, url):
    ...
    card_description = card_url.find_element(By.XPATH, './/div[2]/p').text
