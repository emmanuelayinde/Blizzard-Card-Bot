...
website = 'https://hearthstone.blizzard.com/en-gb/cards?set=march-of-the-lich-king'
...
def scrape(webdriver, Service, chrome_options, WebDriverWait, By, EC):
    ...
    for card in all_cards_link:
        ...
        if tweeted:
            ...
            with open(path +"/data/cards.txt", 'a') as f:
...
# //div[contains(@class, "CardModalContent")]/div/a/div/div/img
